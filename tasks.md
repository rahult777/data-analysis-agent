...
- [ ] Compute `duplicate_row_count` in Python and overwrite the Profiler's copy (it reported 0 against 15 on messy_data.csv); see errors.md 2026-09-25 — the Cleaner already uses its own count since Build G; until this lands the saved profile_report contradicts the cleaning record

...
- [ ] Frontend pause UI — UNBLOCKED 2026-09-25: Build F3 is fully live-validated (visitors see the pause read-only via isOwner; only the owner answers)
- [ ] Pause-state UI — frontend half (pause question components on top of GET /status `pause_data`, the resume form per the decisions.md 2026-09-22 contract, read-only for visitors via `isOwner`) — unblocked 2026-09-25 (Build F3 fully live-validated)
